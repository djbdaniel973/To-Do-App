...
def get_todos(filepath="Todos Functions File.txt"):
...
def write_todos(todo_items):
    ...
    with open("Todos Functions File.txt", "w") as file:
        file.writelines(todo_items)

# This imports the time and prints it in the program.
import time
...
while True:
    ...
    if user_action in ["add", "show", "edit", "completed", "delete", "clear"]:
        ...
        todos = get_todos("Todos Functions File.txt")
